    ...
    <div class="actions">
      ...
      <?php while($subject  = mysqli_fetch_assoc($subject_set)) { ?>
        <tr>
          ...
          <!-- Añadimos la función echo_url al href de edit, delete y view y así creamos enlaces dinámicos 2-->
          <!--Ojo al uso de las funciones u() y h() para normalizar la string para la url -> h(u($subject['id']))) -->
